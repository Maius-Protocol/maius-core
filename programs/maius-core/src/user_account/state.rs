...
pub const UTXO_CAPACITY: usize = 1; // the amount of digital currency remaining after a cryptocurrency transaction is executed that can be stored in the user account at once
...
impl UserAccount {
    pub const SIZE: usize = 8 + 1 + 1 + 32 + SIZE_UTXO*UTXO_CAPACITY;
}
